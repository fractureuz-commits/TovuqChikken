                        ...
                        <div className="input-group" style={{width:'100%'}}>
                            ...
                            <div className="input-row">
                                <div className="debt-box">
                                    <span className="debt-value-black">{FormData.dt_kt_sum} <small>so'm</small></span>
                                    <span className="debt-value-green">{FormData.dt_kt_val} <small>$</small></span>
                                </div>
                                <button onClick={handleSubmit} type="button" className="btn-refresh">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
