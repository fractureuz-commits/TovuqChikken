...
export default function MijozSelect({ onClose,FormData, setFormData, setKontragent, kontragent }) {
    ...
    const handleSubmit = async (id) => {
        ...
        try {
            const result = await apiPost("tovuq-api/tovuq/hs/kontragent/ost_kontragent", {
                code: id,
            });
            setFormData(prev => ({
                ...prev,
