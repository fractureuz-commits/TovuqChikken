// Home sahifasidagi tugmalar ikonkalari

export const SavdoIcon = (
...
export const MahsulotKirimiIcon = (
...
export const BoshQoldiqIcon = (
    <svg width="84" height="84" viewBox="0 0 84 84" fill="none" aria-hidden="true">
        <path d="M10.5 24.5L42 10.5L73.5 24.5L42 38.5L10.5 24.5Z" stroke="white" strokeWidth="6" strokeLinejoin="round" />
        <path d="M10.5 24.5V59.5L42 73.5L73.5 59.5V24.5" stroke="white" strokeWidth="6" strokeLinejoin="round" />
        <path d="M42 38.5V73.5" stroke="white" strokeWidth="6" strokeLinejoin="round" />
        <path d="M31 52L38 59L53 44" stroke="white" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

export const MahsulotYaratishIcon = (
    <svg width="84" height="84" viewBox="0 0 84 84" fill="none" aria-hidden="true">
        <circle cx="42" cy="42" r="32" stroke="white" strokeWidth="7" />
        <path d="M42 26V58M26 42H58" stroke="white" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

export const HarajatIcon = (
    <svg width="84" height="84" viewBox="0 0 84 84" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M59.5 28V17.5C59.5 16.5717 59.1313 15.6815 58.4749 15.0251C57.8185 14.3687 56.9283 14 56 14H21C19.1435 14 17.363 14.7375 16.0503 16.0503C14.7375 17.363 14 19.1435 14 21M14 21C14 22.8565 14.7375 24.637 16.0503 25.9497C17.363 27.2625 19.1435 28 21 28H63C63.9283 28 64.8185 28.3687 65.4749 29.0251C66.1313 29.6815 66.5 30.5717 66.5 31.5V42M14 21V63C14 64.8565 14.7375 66.637 16.0503 67.9497C17.363 69.2625 19.1435 70 21 70H63C63.9283 70 64.8185 69.6313 65.4749 68.9749C66.1313 68.3185 66.5 67.4283 66.5 66.5V56" stroke="white" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M49 49H70" stroke="white" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

export const KontragentIcon = (
    <svg width="84" height="84" viewBox="0 0 84 84" fill="none" aria-hidden="true">
        <circle cx="42" cy="28" r="14" stroke="white" strokeWidth="7" />
        <path d="M14 70C14 56.7452 26.2975 46 42 46" stroke="white" strokeWidth="7" strokeLinecap="round" />
        <path d="M58 58V74M50 66H66" stroke="white" strokeWidth="7" strokeLinecap="round" />
    </svg>
);

export const QaytarishIcon = (
    <svg width="84" height="84" viewBox="0 0 84 84" fill="none" xmlns="http://www.w3.org/2000/svg">
